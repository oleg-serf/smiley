    ...
    <content-box :category="'networkAwards'">
      <template #content>
        <v-card flat class="d-flex flex-column mt-2 rounded-0">
          <iframe
            :height="iframeHeightTwo"
            src="https://www.youtube.com/embed/O-3fzNmsQfQ"
            frameborder="0"
          ...
          <div class="d-flex flex-column">
            <h3 class="mt-2">
              Awards: Smiley Charity film awards | VOTING NOW OPEN!
            </h3>
            <div class="d-flex mt-2">
              <v-btn
                elevation="1"
                color="#ffe61f"
                class="rounded-button pl-12 pr-12"
                >Register</v-btn
              >
            </div>
            <p class="mt-5" v-line-clamp:20="3">
              400 charities entered the awards, More than 110,000 members of the
              public voted and 127 charities made the shortlist in the world's
              biggest cause-based film event
            </p>
