  ...
  <footer class="smiley-footer">
    <div class="container">
      ...
      <div class="social-icons">
        <ul>
          <li>
            <a href="https://facebook.com/SmileyMovement/" target="_blank">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
          ...
          <li>
            <a href="https://twitter.com/Smiley_Movement" target="_blank">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
          ...
          <li>
            <a href="https://www.instagram.com/smileymovement" target="_blank">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
          ...
          <li>
            <a href="https://linkedin.com/company/smiley-movement" target="_blank">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
