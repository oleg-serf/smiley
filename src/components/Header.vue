        ...
        <div class="top-line-wrap">
          ...
          <div class="top-menu">
            ...
            <div class="menu-links">
              <router-link to="/talks" class="menu-item"><span>Smiley talks</span></router-link>
              <router-link to="/news" class="menu-item"><span>Smiley news</span></router-link>
<!--              <a class="menu-item" href="#"><span>Smiley awards</span></a>-->
              <a class="menu-item" href="#"><span>Network</span></a>
              <router-link to="/our-story" class="menu-item"><span>Our story</span></router-link>
              <div class="btn-wrap">
                ...
                <div class="avatar-icon">
                  ...
                  <ul>
                    <li>
                      <a href="#">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path fill-rule="evenodd" clip-rule="evenodd" d="M6 16C3.79086 16 2 14.0812 2 11.7143C2 9.78982 3.19155 8.13306 4.86361 7.60405C5.74104 5.4454 7.7417 4 10 4C12.8522 4 15.2063 6.28456 15.5554 9.23893C16.9581 9.60266 18 10.9567 18 12.5714C18 14.3901 16.6749 15.8894 14.9641 15.9953L14.8 16H6ZM6 14L14.8406 13.9991C15.4685 13.9603 16 13.3602 16 12.5714C16 11.876 15.58 11.3115 15.0534 11.1749C14.2553 10.968 13.6659 10.2924 13.5692 9.47359C13.3328 7.47287 11.7844 6 10 6C8.59574 6 7.30266 6.91486 6.7164 8.35716C6.51471 8.85335 6.12357 9.24551 5.63372 9.44985L5.32061 9.56428C4.55329 9.88244 4 10.7274 4 11.7143C4 13.0063 4.92744 14 6 14Z" fill="#1A1A1A"/>
                        </svg>
                        My News Feed
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path fill-rule="evenodd" clip-rule="evenodd" d="M7.5 10C8.8739 10 10.1301 10.5129 11.0941 11.361C11.6809 11.1285 12.3248 11 13 11C15.7614 11 18 13.149 18 15.8C18 16.4627 17.4404 17 16.75 17H3.375C2.61561 17 2 16.3732 2 15.6C2 12.5072 4.46243 10 7.5 10ZM7 3C8.65685 3 10 4.34315 10 6C10 7.65685 8.65685 9 7 9C5.34315 9 4 7.65685 4 6C4 4.34315 5.34315 3 7 3ZM14 5C15.1046 5 16 5.89543 16 7C16 8.10457 15.1046 9 14 9C12.8954 9 12 8.10457 12 7C12 5.89543 12.8954 5 14 5Z" fill="#1A1A1A"/>
                        </svg>
...
<!--                </a>-->
                <div class="login-register-btns-wrap">
                  <a class="login-register-btn" @click="registerDropdownShow = !registerDropdownShow">Login / Register</a>
                  <div class="login-and-new-account-btns"  v-on-clickaway="away" v-if="registerDropdownShow"  id="dropdown-content">
