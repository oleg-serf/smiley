    ...
    <div class="organization-content-wrap">
      ...
      <div  class="organization-tabs" id="tabs">
        <ul class="tabs-nav">
          ...
          <li><a href="#tab-2">Our project</a></li>
          <li><a href="#tab-3">Our news</a></li>
          <li><a href="#tab-4">Smiley hub</a></li>
        </ul>
    ...
    $(window).on('resize', function() {
      ...
      if(firstInit){
        if($(window).width()>=768) {
          ...
          tabAcc.hide().next().removeClass('panel');
        }
        else{
          tab.show();
          tabAcc.show().next().addClass('panel');
        }
