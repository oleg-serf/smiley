  ...
  <div>
      ...
      <div class="news-category-container">
        ...
        <a  href="#" class="article-item">
          ...
          <div class="article-descr">
            ...
            <div class="article-title">This 11-year-old extinction rebellion activist is driving climate action in south africa</div>
            <div class="article-subtitle">What are you doing for the earth in this time of crisis? Our planet is facing an environmental emergency which authorities are doing little to halt.</div>
          </div>
        </a>
        ...
        <a  href="#" class="article-item">
          <div class="smiley-img-wrap">
            <div class="smiley-img">
              <img src="img/news/news-category-1-item-2.jpg" alt="News item 2">
            </div>
            <div class="icon-wrap">
        ...
        <a  href="#" class="article-item">
          <div class="smiley-img-wrap">
            <div class="smiley-img">
              <img src="img/news/news-category-1-item-3.jpg" alt="News item 3">
            </div>
            <div class="icon-wrap">
              <img src="img/homepage/icon-07.png" alt="icon">
            </div>
    ...
    <section class="news-category-section container">
      ...
      <div class="news-category-container">
        ...
        <h2 class="news-category-title">Quality education</h2>

        <a  href="#" class="article-item">
          <div class="smiley-img-wrap">
            <div class="smiley-img">
              <img src="img/news/news-category-2-item-1.jpg" alt="News item 1">
            </div>
          </div>
          <div class="article-descr">
            <div class="article-date-location">
            ...
            <div class="article-title">Vending Machines Offer Free Books to Children</div>
            <div class="article-subtitle">What are you doing for the earth in this time of crisis? Our planet is facing an environmental emergency which authorities are doing little to halt.</div>
          </div>
        </a>
        ...
        <a  href="#" class="article-item">
          <div class="smiley-img-wrap">
            <div class="smiley-img">
              <img src="img/news/news-category-2-item-2.jpg" alt="News item 2">
            </div>
          </div>
          <div class="article-descr">
            <div class="article-date-location">
            ...
            <div class="article-title">Italy to put sustainability and climate at heart of learning in schools</div>
            <div class="article-subtitle">What are you doing for the earth in this time of crisis? Our planet is facing an environmental emergency which authorities are doing little to halt.</div>
          </div>
        </a>
        ...
        <a  href="#" class="article-item">
          <div class="smiley-img-wrap">
            <div class="smiley-img">
              <img src="img/news/news-category-2-item-3.jpg" alt="News item 3">
            </div>
          </div>
          <div class="article-descr">
            <div class="article-date-location">
            ...
            <div class="article-title">This Advocate Is Empowering Youth Across Kenya's Slums</div>
            <div class="article-subtitle">What are you doing for the earth in this time of crisis? Our planet is facing an environmental emergency which authorities are doing little to halt.</div>
          </div>
        </a>
    ...
    <section class="news-category-section container">
      ...
      <div class="news-category-container">
        ...
        <h2 class="news-category-title">Reduced inequalities</h2>

        <a  href="#" class="article-item">
          <div class="smiley-img-wrap">
            <div class="smiley-img">
              <img src="img/news/news-category-3-item-1.jpg" alt="News item 1">
            </div>
          </div>
          <div class="article-descr">
            <div class="article-date-location">
        ...
        <a  href="#" class="article-item">
          <div class="smiley-img-wrap">
            <div class="smiley-img">
              <img src="img/news/news-category-3-item-2.jpg" alt="News item 2">
            </div>
          </div>
          <div class="article-descr">
            <div class="article-date-location">
        ...
        <a  href="#" class="article-item">
          <div class="smiley-img-wrap">
            <div class="smiley-img">
              <img src="img/news/news-category-3-item-3.jpg" alt="News item 3">
            </div>
          </div>
          <div class="article-descr">
            <div class="article-date-location">
    ...
    <section class="news-category-section container">
      ...
      <div class="news-category-container">
        ...
        <a  href="#" class="article-item">
          <div class="smiley-img-wrap">
            <div class="smiley-img">
              <img src="img/news/news-category-4-item-1.jpg" alt="News item 1">
            </div>
          </div>
          <div class="article-descr">
            <div class="article-date-location">
        ...
        <a  href="#" class="article-item">
          <div class="smiley-img-wrap">
            <div class="smiley-img">
              <img src="img/news/news-category-4-item-2.jpg" alt="News item 2">
            </div>
          </div>
          <div class="article-descr">
            <div class="article-date-location">
        ...
        <a  href="#" class="article-item">
          <div class="smiley-img-wrap">
            <div class="smiley-img">
              <img src="img/news/news-category-4-item-3.jpg" alt="News item 3">
            </div>
          </div>
          <div class="article-descr">
            <div class="article-date-location">
    ...
    <section class="news-category-section container">
      ...
      <div class="news-category-container">
        ...
        <a  href="#" class="article-item">
          <div class="smiley-img-wrap">
            <div class="smiley-img">
              <img src="img/news/news-category-5-item-1.jpg" alt="News item 1">
            </div>
          </div>
          <div class="article-descr">
            <div class="article-date-location">
        ...
        <a  href="#" class="article-item">
          <div class="smiley-img-wrap">
            <div class="smiley-img">
              <img src="img/news/news-category-5-item-2.jpg" alt="News item 2">
            </div>
          </div>
          <div class="article-descr">
            <div class="article-date-location">
        ...
        <a  href="#" class="article-item">
          <div class="smiley-img-wrap">
            <div class="smiley-img">
              <img src="img/news/news-category-5-item-3.jpg" alt="News item 3">
            </div>
          </div>
          <div class="article-descr">
            <div class="article-date-location">
