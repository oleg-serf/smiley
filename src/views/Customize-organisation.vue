      ...
      <div class="customize-organisation-content">
        ...
        <div class="upload-organisation-image-wrap">
          ...
          <div class="organisation-image">
            <img src="img/customize-organisation/logo-samgung.png" alt="your logo">
          </div>
            ...
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
              ...
              <g>
                  <path d="M57.746,14.658h-2.757l-1.021-3.363c-0.965-3.178-3.844-5.313-7.164-5.313H28.801c-3.321,0-6.201,2.135-7.165,5.313
                      ...
                      c5.769,0,10.462,4.693,10.462,10.462L68.208,51.762L68.208,51.762z" fill="#fff"/>
                <path d="M37.228,25.406c-8.844,0-16.04,7.195-16.04,16.04c0,8.844,7.195,16.039,16.04,16.039s16.041-7.195,16.041-16.039
                      ...
                      c5.537,0,10.041,4.504,10.041,10.04C47.269,46.982,42.765,51.486,37.228,51.486z" fill="#fff"/>
              </g>
            </svg>
          </div>
        ...
        <p>Upload an organization logo</p>

        <form class="add-organisation-info">

          <label for="organisation-website">Organisation Website
            <input type="text" name="organisation-website" id="organisation-website" placeholder="www.yoursite.co.uk">
          </label>

          <div class="soc-net-link-wrap">
            <label class="link-label" for="facebook-link">Social Networks:
              <div class="input-wrap" @click="addLinkFacebook = true">
                <input type="text" name="facebook-link" id="facebook-link" placeholder="Facebook" disabled>
              </div>
            </label>

            <div class="facebook-link-input-wrap" v-if="addLinkFacebook">
              <label for="paste-facebook-link">Paste link
                <input type="text" name="paste-facebook-link" id="paste-facebook-link" placeholder="">
              </label>
              <button class="save-facebook-link-btn" @click.prevent="addLinkFacebook = false">Save</button>
            </div>

          </div>

          <div class="soc-net-link-wrap">
            <label class="link-label" for="twitter-link">
              <div class="input-wrap" @click="addLinkTwitter = true">
                <input type="text" name="twitter-link" id="twitter-link" placeholder="Twitter" disabled>
              </div>
            </label>

            <div class="twitter-link-input-wrap"  v-if="addLinkTwitter">
              <label for="paste-twitter-link">Paste link
                <input type="text" name="paste-twitter-link" id="paste-twitter-link" placeholder="">
              </label>
              <button class="save-twitter-link-btn" @click.prevent="addLinkTwitter = false">Save</button>
            </div>
        ...
        <div class="checkbox-wrap">
          <label class="register-checkbox">I accept the following <a href="#">Terms and Conditions</a>
            <input type="checkbox">
            <span class="register-checkmark">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M5.91006 10.4959L3.7071 8.29291C3.31658 7.90239 2.68342 7.90239 2.29289 8.29291C1.90237 8.68343 1.90237 9.3166 2.29289 9.70712L5.29288 12.7071C5.7168 13.131 6.4159 13.0892 6.7863 12.6178L13.7863 4.61786C14.1275 4.18359 14.0521 3.55494 13.6178 3.21372C13.1835 2.87251 12.5549 2.94795 12.2136 3.38222L5.91006 10.4959Z" fill="#000"/></svg>
          </span>
          </label>
        </div>

        <div class="finish-btn-wrap">
          <button class="finish-btn" type="submit" name="submit" value="finish-creating">FINISH CREATING YOUR ORGANIZATION</button>
        </div>
...
<style lang="scss" scoped>
  ...
  .customize-organisation {
    text-align: center;
    padding-bottom: 89px;
    .customize-organisation-content{
      max-width: 762px;
      margin: 0 auto;
    }
    .customize-organisation-title {
      color: $default-text;
    ...
    .upload-organisation-image-wrap{
      width: 174px;
      height: 174px;
      position: relative;
      margin: 0 auto;
