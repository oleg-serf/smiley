  ...
  <div class="home">
    <div class="header-bg">
      <div class="header-content-wrap container">
        <div class="header-content">
          <h1 class="header-content-title">Helping You<br> Help Others</h1>
          <router-link to="/talks"  class="header-btn">Learn more</router-link>
        </div>
      </div>
    </div>
    <section class="smiley-talks container">
      <div class="smiley-talks-left">
        ...
        <router-link to="/talks" class="read-more-link"><span></span>Read more</router-link>
      </div>
        ...
        <router-link  :to="'/event/' + topEvent.id" class="article-item" v-if="topEvent">
          ...
          <div class="article-descr">
            <div class="article-date-location">
              <div class="article-date">{{new Date(topEvent.date).toLocaleDateString('nl', {day:"2-digit",month:"2-digit",year:"numeric"})}}</div>
      ...
      <div class="smiley-talks-right" v-if="eventList">
        <router-link  :to="'/event/' + event.id" class="article-item" v-for="(event, index) in eventList" :key="event.id">
          <div class="smiley-img-wrap">
            <div class="smiley-img">
          ...
          <div class="article-descr">
            <div class="article-date-location">
              <div class="article-date">{{new Date(event.date).toLocaleDateString('nl', {day:"2-digit",month:"2-digit",year:"numeric"})}}</div>
    ...
    <section class="smiley-network container">

      <div class="smiley-network-title-wrap">
        <div class="smiley-network-title">
          <svg width="170" height="55" viewBox="0 0 170 55" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M165.95 25.5531C165.95 25.3528 165.88 25.1769 165.734 25.031C165.591 24.8908 165.393 24.8193 165.153 24.8193H164.329V26.2912H165.153C165.393 26.2912 165.591 26.2211 165.734 26.0766C165.88 25.9336 165.95 25.7619 165.95 25.5531V25.5531ZM165.95 28.9202L164.949 26.9921H164.329V28.9202H163.433V24.0626H165.264C165.498 24.0626 165.707 24.1027 165.899 24.1842C166.09 24.2614 166.254 24.373 166.391 24.5032C166.529 24.6348 166.633 24.8021 166.715 24.9881C166.792 25.164 166.832 25.3571 166.832 25.5531C166.832 25.9035 166.742 26.1882 166.553 26.4056C166.363 26.6259 166.142 26.7804 165.873 26.8748L166.957 28.9202H165.95ZM168.601 26.4957C168.601 25.9879 168.506 25.5045 168.32 25.0639C168.128 24.6076 167.878 24.2228 167.554 23.8996C167.23 23.5691 166.849 23.3188 166.418 23.1186C165.98 22.9326 165.515 22.8396 165.005 22.8396C164.502 22.8396 164.023 22.9326 163.584 23.1186C163.148 23.3188 162.768 23.5691 162.443 23.8996C162.121 24.2228 161.866 24.6076 161.677 25.0639C161.492 25.5045 161.396 25.9879 161.396 26.4957C161.396 27.0149 161.492 27.4955 161.677 27.9404C161.866 28.3867 162.121 28.7743 162.443 29.099C162.768 29.4266 163.148 29.6941 163.584 29.8771C164.023 30.0674 164.502 30.1661 165.005 30.1661C165.515 30.1661 165.98 30.0674 166.418 29.8771C166.849 29.6941 167.23 29.4266 167.554 29.099C167.878 28.7743 168.128 28.3867 168.32 27.9404C168.506 27.4955 168.601 27.0149 168.601 26.4957V26.4957
/>
            <path fill-rule="evenodd" clip-rule="evenodd" d="M82.202 1H87.841C88.2291 1 88.543 1.30396 88.543 1.67841V25.8003H103.799C104.186 25.8003 104.5 26.1043 104.5 26.4787V31.3201C104.5 31.696 104.186 32 103.799 32H81.5V1.67841C81.5 1.30396 81.8139 1 82.202 1" fill="white"/>
            <path fill-rule="evenodd" clip-rule="evenodd" d="M109.161 1H130.624C130.991 1 131.287 1.30396 131.287 1.67841V6.38767C131.287 6.76211 130.991 7.06608 130.624 7.06608H115.101V13.3554H128.684C129.047 13.3554 129.344 13.6579 129.344 14.0323V18.7445C129.344 19.1189 129.047 19.4229 128.684 19.4229H115.101V25.9325H130.836C131.204 25.9325 131.5 26.2379 131.5 26.6123V31.3201C131.5 31.696 131.204 32 130.836 32H109.161C108.796 32 108.5 31.696 108.5 31.3201V1.67841C108.5 1.30396 108.796 1 109.161 1" fill="white"/>
            <path fill-rule="evenodd" clip-rule="evenodd" d="M146.038 19.7768L134.608 2.04258C134.318 1.59178 134.646 1 135.19 1H141.642C141.885 1 142.11 1.12628 142.234 1.33186L149.55 13.4449L156.995 1.32893C157.12 1.12482 157.342 1 157.584 1H163.809C164.354 1 164.683 1.59325 164.391 2.04552L152.967 19.6432V31.3216C152.967 31.696 152.657 32 152.278 32H146.727C146.345 32 146.038 31.696 146.038 31.3216V19.7768Z" fill="white"/>
          </svg>
          <span>Network</span>
        </div>
      </div>
      ...
      <div class="smiley-network-descr">
        <div class="network-descr-wrap">
          ...
          <div class="smiley-network-descr-subtitle">Connect your organisation with the Smiley Community and find the skills based support you need and raise awareness of your positive impact projects</div>
        </div>
      ...
      <div class="smiley-news-center">
        <a  href="#" class="article-item">
          ...
          <div class="article-descr">
            ...
            <div class="article-title">'Lobsters and octopuses are back': the Kenyan women leading a reef revival</div>
...
<!--    <section class="smiley-awards">-->
<!--      <div class="smiley-awards-wrap">-->
<!--        <div class="smiley-awards-main-title">-->
<!--          <img src="img/homepage/smiley-awards-main-title.svg" alt="smiley awards">-->
<!--        </div>-->
<!--        <div class="smiley-awards-content">-->
<!--          <img src="img/homepage/smiley-awards-pic.jpg" alt="awards main pic">-->
<!--          <div class="smiley-awards-text">-->
<!--            <div class="smiley-awards-title">-->
<!--              Aplications close on april 1st 2020-->
<!--            </div>-->
<!--            <div class="smiley-awards-descr">-->
<!--              The Smiley Awards were created to reward and encourage extraordinary projects that align with one of the 17 Sustainable Development Goals of 2020.-->
<!--            </div>-->
<!--            <div class="smiley-awards-prize">-->
<!--              Total prize money-->
<!--            </div>-->
<!--            <div class="smiley-awards-money">-->
<!--              £ 100,000-->
<!--            </div>-->
<!--            <a href="#" class="read-more-link"><span></span>Learn more about the awards</a>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="selection-link">-->
<!--        <a href="#">click here for eligibility and selection process</a>-->
<!--      </div>-->
...
<!--        <h2>Sign up to our mailing list and find us on social</h2>-->
        ...
        <div class="video-content">
          <div class="video-content-item">
            ...
            <div class="video-descr">
              ...
              <div class="video-content-subtitle">
                Jo Loughran at Let's Talk Mental Health
              </div>
            </div>
          </div>
          ...
          <div class="video-content-item">
            ...
            <div class="video-descr">
              ...
              <div class="video-content-subtitle">
                Georgia Dodsworth at Let's Talk Mental Health
              </div>
            </div>
          </div>
        </div>
...
<style lang="scss" scoped>
  ...
  .header-bg{
    background: url(/img/homepage/header-bg-mob-x2.jpg) no-repeat;
    ...
    @include lg{
      background: url(/img/homepage/header-bg-dt-x1.jpg) no-repeat;
    ...
    .header-content-title{
      margin-top: 140px;
      color: #FFF;
      font: 50px/50px 'Montserrat Bold', sans-serif;
      text-align: center;
      text-transform: uppercase;
      @include sm{
        margin-top: 160px;
        font: 70px/90px 'Montserrat Bold', sans-serif;
      }
      @include md{
        margin-top: 180px;
      }
      @include lg{
        margin-bottom: 114px;
        font: 100px/120px 'Montserrat Bold', sans-serif;
      }
      @include xl{
        font: 120px/160px 'Montserrat Bold', sans-serif;
      }
    }
    .header-btn{
  ...
  .smiley-network{
    ...
    .smiley-network-title{
      ...
      span{
        color: #fff;
        font: 600 18px/18px 'Montserrat SemiBold', sans-serif;
        text-transform: uppercase;
        letter-spacing: 12px;
        margin-top: -15px;
        @include lg{
          font: 600 30px/30px 'Montserrat SemiBold', sans-serif;
          letter-spacing: 16px;
        }
      }
      @include xl{
    ...
    .smiley-network-descr{
      background: url(/img/homepage/network-mobile-bg.png) no-repeat;
      ...
      padding: 22px 0 35px;
      @include md{
        background: url(/img/homepage/network-dt-bg.png) no-repeat;
        background-size: cover;
        background-position: 50%;
      }
      @include xl{
    ...
    .network-descr-wrap{
      ...
      @include xl{
        align-items: flex-start;
        text-align: left;
        padding: 21px 0 29px 45px;
      }
    }
    .smiley-network-descr-title{
      color: #fff;
      font: 700 26px/39px 'Montserrat Bold', sans-serif;
      text-transform: uppercase;
      margin-bottom: 4px;
      @include md{
  ...
  .smiley-awards{
    ...
    .smiley-awards-wrap{
      .smiley-awards-main-title{
        height: 151px;
        text-align: center;
        background-color: #A04894;
        position: absolute;
        top: 0;
        left: 0;
        width: 100%;
    ...
    .smiley-awards-text{
      ...
      .read-more-link{
        color: #A04894;
        border-bottom: 2px solid #A04894;
        span{
          background-color: #A04894;
          &:before,
          &:after{
  ...
  // ---------- SMILEY VIDEO INDEX SECTION

  .smiley-video-section{
    padding-top: 37px;
    padding-bottom: 96px;
    position: relative;
    &:after{
    ...
    .video-content-item{
      ...
      .video-descr{
        .video-content-title{
          color: $default-text;
          font: 700 22px/33px 'Montserrat Bold', sans-serif;
          text-transform: uppercase;
        }
        .video-content-subtitle{
          color: $default-text;
          font: 400 18px/27px 'Muli', sans-serif;
        }
        @include sm{
          .video-content-title{
            font: 700 26px/39px 'Montserrat Bold', sans-serif;
