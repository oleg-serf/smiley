<template>
  <div>
    <v-row no-gutters>
      ...
      <top-picks
        v-if="$vuetify.breakpoint.smAndUp && features.length"
        :features="features"
      />
      <top-picks-mobile
        v-if="$vuetify.breakpoint.xs && features.length"
        :features="features"
      />
      <!-- LEFT SIDE ENDS  -->
      ...
      <daily-news
        v-if="$vuetify.breakpoint.smAndUp && dailyNews.length"
        :news="dailyNews.slice(0, 5)"
      />
      <daily-news-mobile
        v-if="$vuetify.breakpoint.xs && dailyNews.length"
        :news="dailyNews"
      />
      ...
      <!-- OTHER NEWS PART -->
      <other-news
        v-if="$vuetify.breakpoint.mdAndUp && latestNews.length"
        :news="latestNews"
      />
      <other-news-mobile
      ...
      <network-popular
        v-if="$vuetify.breakpoint.mdAndUp && networkPopular.length"
        :networks="networkPopular"
      />
      <network-popular-mobile
        v-if="$vuetify.breakpoint.width < 769 && networkPopular.length"
        :networks="networkPopular"
      />
      <!-- NETWORK PARTT -->
      ...
      <!-- NETWORKK DISCOVERRR -->
      <network-discovery
        v-if="$vuetify.breakpoint.mdAndUp && networkDiscover.length"
        :networks="networkDiscover"
      />
      <network-discovery-mobile
        v-if="$vuetify.breakpoint.width < 769 && networkDiscover.length"
        :networks="networkDiscover"
      />
      <!-- NETWORK DISCOVERRR -->
    </v-row>
...
export default {
  ...
  components: {
    networkDiscovery: () =>
      import("../components/Home-New/Web/NetworkDiscover"),
    networkDiscoveryMobile: () =>
      import("../components/Home-New/Mobile/NetworkDiscoveryMobile"),
    networkPopular: () => import("../components/Home-New/Web/NetworkPopular"),
    networkPopularMobile: () =>
      import("../components/Home-New/Mobile/NetworkPopularMobile"),
    networkAwards: () => import("../components/Home-New/Web/NetworkAwards"),
    bestNews: () => import("../components/Home-New/Web/BestNews"),
    networkAwardsMobile: () =>
      import("../components/Home-New/Mobile/NetworkAwardsMobile"),
    topPicks: () => import("../components/Home-New/Web/TopPicks"),
    topPicksMobile: () =>
      import("../components/Home-New/Mobile/TopPicksMobile"),
    dailyNews: () => import("../components/Home-New/Web/DailyNews"),
    dailyNewsMobile: () =>
      import("../components/Home-New/Mobile/DailyNewsMobile"),
    otherNews: () => import("../components/Home-New/Web/OtherNews"),
    otherNewsMobile: () =>
      import("../components/Home-New/Mobile/OtherNewsMobile"),
