        ...
        <div class="event-content-wrap">
            ...
            <div class="sidebar-block">
              ...
              <div class="panel">
                <div class="panel-content-wrap">
                  <div class="event-date-time">{{new Date(event.date).toLocaleDateString('en-US', {weekday: 'short', day: 'numeric', month: 'long', year: 'numeric'}).replace(',','')}}</div>
                  <div class="event-date-time">{{event.time_start}} - {{event.time_end}}</div>
                </div>
              </div>
            </div>
            <div class="sidebar-block">
                  ...
                  <div class="speaker-item" v-for="speaker in event.speakers" :key="speaker.id">
                    <div class="speaker-avatar-wrap">
                      <div class="speaker-avatar">
                        <img :src="'https://new-smiley.s3.eu-west-2.amazonaws.com/speakers/s_' + speaker.image">
                      </div>
                    </div>
                      ...
                      <li>
                        <a href="#">
                          <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M15 30C23.2843 30 30 23.2843 30 15C30 6.71573 23.2843 0 15 0C6.71573 0 0 6.71573 0 15C0 23.2843 6.71573 30 15 30Z" fill="#3B5998"/>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M12.938 22.3012H15.67V14.7971H17.7195L18.1248 12.4524H15.67V10.7533C15.67 10.2056 16.0241 9.63047 16.5303 9.63047H17.9255V7.28571H16.2156V7.29623C13.5403 7.39333 12.9906 8.94276 12.943 10.5703H12.938V12.4524H11.5713V14.7971H12.938V22.3012Z" fill="white"/>
                          </svg>
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M15 30C23.2843 30 30 23.2843 30 15C30 6.71573 23.2843 0 15 0C6.71573 0 0 6.71573 0 15C0 23.2843 6.71573 30 15 30Z" fill="#0976B4"/>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M9.15654 11.1286C10.1892 11.1286 11.0264 10.3651 11.0264 9.42233C11.0264 8.47869 10.1892 7.71423 9.15654 7.71423C8.12287 7.71423 7.28571 8.47869 7.28571 9.42233C7.28571 10.3651 8.12287 11.1286 9.15654 11.1286Z" fill="white"/>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M7.71429 22.1047H11.0693V12.4286H7.71429V22.1047Z" fill="white"/>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M15.7781 16.723C15.7781 15.6134 16.3031 14.5283 17.5584 14.5283C18.8138 14.5283 19.1224 15.6134 19.1224 16.6965V21.9811H22.4624V16.4805C22.4624 12.6588 20.2034 12 18.8138 12C17.4253 12 16.6594 12.4697 15.7781 13.6077V12.305H12.4286V21.9811H15.7781V16.723Z" fill="white"/>
                          </svg>
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M15 30C23.2843 30 30 23.2843 30 15C30 6.71573 23.2843 0 15 0C6.71573 0 0 6.71573 0 15C0 23.2843 6.71573 30 15 30Z" fill="#DD4B39"/>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M8.01355 15.7499C8.05747 13.1741 10.4732 10.9182 13.1008 11.0042C14.3597 10.947 15.5432 11.484 16.5075 12.2384C16.0961 12.6966 15.67 13.1384 15.2145 13.5514C14.0554 12.7659 12.4066 12.5416 11.2476 13.4488C9.58907 14.573 9.51373 17.2276 11.1087 18.4378C12.6599 19.8177 15.592 19.1324 16.0206 17.0198C15.0489 17.0055 14.0748 17.0198 13.1032 16.9889C13.1008 16.4207 13.0984 15.8525 13.1008 15.2843C14.7251 15.2796 16.3494 15.2772 17.9761 15.2891C18.0735 16.6259 17.8933 18.0486 17.0556 19.154C15.7868 20.9038 13.2395 21.4147 11.2524 20.6651C9.25803 19.9203 7.84552 17.8553 8.01355 15.7499Z" fill="white"/>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M20.34 13H21.6622C21.6644 13.4423 21.6667 13.8866 21.6711 14.3289C22.1134 14.3333 22.5577 14.3333 23 14.3378V15.66C22.5577 15.6644 22.1156 15.6667 21.6711 15.6711C21.6667 16.1156 21.6644 16.5579 21.6622 17H20.3378C20.3333 16.5579 20.3333 16.1156 20.3289 15.6733C19.8866 15.6689 19.4421 15.6644 19 15.66V14.3378C19.4421 14.3333 19.8844 14.3311 20.3289 14.3289C20.3311 13.8844 20.3356 13.4423 20.34 13Z" fill="white"/>
                          </svg>
                        </a>
                      </li>
                      <li>
          ...
          <div  class="event-tabs" id="tabs">
            ...
            <div class="tabs-items">
              <div :class="'tabs-item item-' + ++index" :id="'tab-' + index" v-for="(ev, index) in event.event_blocks" :key="ev.id">
          ...
          <section class="event-partners ">
            <div class="event-partners-wrap">
              ...
              <div class="event-partners-cards">
                <img src="/img/event/partners.jpg" alt="partners">
              </div>
            </div>
          </section>
          ...
          <section class="invite-friends ">
            <div class="invite-friends-section-wrap">
              ...
              <form class="invite-friends-form-wrap">
                <label for="invite">
                  <input type="text" name="invite" id="invite" placeholder="Separate multiple emails with commas">
                </label>
        ...
        setTimeout(() => {
          ...
          $(window).on('resize', function() {
            ...
            if($(window).width()>=1200) {
              $(acc).addClass('active').attr('disabled', true).next().css('max-height', 'initial');
            }
            if($(window).width()<1200){
              $(acc).removeClass('active').attr('disabled', false).next().removeAttr('style');
            }
          });
